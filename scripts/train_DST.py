...
from crazyneuraluser.config import global_config as cfg  # or config21
from crazyneuraluser.dst import ignore_none_dontcare, default_cleaning, IGNORE_TURNS_TYPE2, paser_bs
...
from crazyneuraluser.compute_joint_acc import compute_jacc
import warnings
import collections
